			...
			<li>회사가 회원가입 시 수집하는 개인정보 항목과 그 수집 ∙ 이용의 주된 목적은 아래 표와 같습니다.
				...
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						...
						<td width="246" valign="top" rowspan="5"><p>- 회원가입 및 서비스 결제<br/>
							- 사용자 식별 및 서비스 운영
							</p></td>
					</tr>
					<tr>
					...
					<tr>
						<td width="113" valign="top"><p>뉴욕타임스<br/>뉴스뱅크</p></td>
						<td width="246" valign="top"><p><개인회원><br/>
							[필수] 아이디, 비밀번호, 이메일, 이름, 연락처, 접속 로그, 쿠키, 접속 IP 정보, 결제기록<br/>
							[선택] 신용카드 정보, 은행계좌정보, 현금영수증 정보<br/>
							<기관/법인회원><br/>
		...
		<ol>
			...
			<li>회사에서 고객의 개인정보를 위탁하는 현황은 다음과 같습니다.
				<table border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="203"><p>(주)토스페이먼츠</p></td>
						<td width="249"><p>결제처리</p></td>
						<td width="249"><p>마케팅관리팀</p></td>
					</tr>
					<tr>
						<td width="203"><p>(주)이노포스트</p></td>
						<td width="249"><p>SMS 발송</p></td>
						<td width="249"><p>경영관리실</p></td>
					</tr>
				</table>
			</li>
		</ol>
...
※ 중앙행정심판위원회 : (국번없이) 110(center.simpan.go.kr)						
	...
	<section class="policy_cont" id="section12">
		...
		<p>개인정보취급방침은 법령•정책 및 회사 내부 운영방침 또는 보안기술의 변경에 따라 내용이 변경될 수 있으며, 이 때 변경되는 개인정보취급방침은 회사 사이트의 공지사항에 변경 이유 및 내용 등을 고지하도록 하겠습니다.</p><br>
		<ul>
	...
	<section class="policy_cont" id="section14">
		<h4>개인정보처리방침 변경사항</h4>
		<p><a class="otherPrivacy" href="policy_230706.jsp">이전 개인정보처리방침(2023. 7. 6. ~) 보기</a></p>
