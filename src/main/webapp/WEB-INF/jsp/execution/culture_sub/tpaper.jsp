...
새로 추가한 홈 화면에서는 오늘의 1면 주요기사, 현재 날씨, 추천 도서 등 다양한 콘텐츠를 더해 활용성을 높였습니다.<br>
앞으로 추가될 더 다양한 기능과 콘텐츠를 기대해주세요.</p>
    ...
    <section class="prod_head">
        <div class="inner">신문은 시대를 기록하고 읽는 문화 그 자체입니다. <br>미디어는 공간에 대한 특별한 기억을 남깁니다. <br>
공간에 잘 어울리는 디자인과 <b>설치까지 지원</b>해드립니다.</div>
    </section>
    ...
    <section class="prod_detail2">
        <div class="inner grid3">
            <div class="prod_box">
                ...
                <div class="prod_box_txt">
                    <p>고화질 홍보영상</p>
                    <span>고화질 홍보영상과 티커가 <br>홈 화면에서 노출되어 홍보효과를 높입니다. <br>대기화면의 다양한 옵션을 통해<br>이용기관이 원하는 동영상, 이미지 또는 지면을 <br>보여줄 수 있습니다.</span>
                </div>
            </div>
            <div class="prod_box">
                ...
                <div class="prod_box_txt">
                    <p>맞춤형 콘텐츠</p>
                    <span>추천 도서, 지역 날씨, 정책 홍보 등 이용기관에 따라 <br>맞춤형 콘텐츠를 제공할 수 있습니다.</span>
                </div>
            </div>
            <div class="prod_box">
                <div class="prod_img"><img src="<%=request.getContextPath()%>/images/tpaper2-3.png"></div>
                <div class="prod_box_txt">
                    <p>효율적인 관리 시스템</p> <span>종이신문을 비치하고 보관하는 데 드는<br>노력과 공간을 절감할 뿐만 아니라 <br>키오스크 자동실행, 이용통계를 통한 기기관리 등<br>효율적인 관리시스템을 제공합니다.</span>
                </div>
            </div>
        </div>
    </section>
