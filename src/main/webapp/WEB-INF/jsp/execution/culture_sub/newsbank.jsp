    ...
    <section class="subpg_tit">
        ...
        <div class="inner">
            <div>
                <h2>대한민국 보도사진 박물관 </h2>
                <h3>뉴스뱅크</h3>
                <p class="subtit_txt">뉴스뱅크는 25개 언론사의 보도사진 650만 컷 이상을 보유하고 있는 국내 최대의 보도사진 통합 라이브러리입니다.<br>신미양요, 병인양요의 19세기 사진을 비롯해 일제 강점기를 지나 6.25 전쟁을 거치고 산업화와 민주화 시대를 거쳐 오늘에 이르기까지<br>대한민국 근현대사의 중요 장면이 생생한 보도사진으로 기록되어 남아 있습니다.</p>
            </div>
        ...
        <div class="inner grid3">
            <div class="prod_box">
                ...
                <div class="prod_box_txt">
                    ...
                    <span>다하미는 UCI 총괄기구인 한국저작권위원회에 의해 <br>2016년 언론사 보도사진 분야의 <br>UCI 등록관리기관으로 지정되었습니다.<br>
등록관리기관은 디지털 콘텐츠 등록자로부터 <br>콘텐츠에 대한 식별정보를 등록 받고, <br>해당 콘텐츠에 UCI를 발급하는 업무를 <br>수행하는 기관을 말합니다.</span>
                </div>
            </div>
            <div class="prod_box">
                ...
                <div class="prod_box_txt">
                    <p>등록관리기관의 역할</p>
                    <span>등록자 승인, 등록자 코드발급 등 등록자 관리<br>
메타데이터의 등록, 식별자 발급 및 유지 관리<br>
식별메타데이터의 총괄기구로의 전송<br>
식별자와 함께 관리되는 URL(Uniform Resource Locator) 정보의 유효성 확인<br>
총괄시스템과의 연계, 응용서비스 개발 및 서비스</span>
            ...
            <div class="prod_box">
                ...
                <div class="prod_box_txt">
                    <p>디지털 콘텐츠 유통을 원활하게</p> <span>UCI는 디지털 콘텐츠에 유일한 코드를 부여하는 <br>국가표준 식별체계로, 식별 범위는 <br>국내 지역에 한정되지 않고 전 세계적입니다.<br>
 UCI는 자원의 유통 기반 역할을 수행하게 되며<br>
유통내역 추적, 거래인증, 참조연계서비스 등 <br>온라인과 오프라인 구분 없이 실질적인 활용분야에 다양하게 적용됩니다.</span>
                </div>
            </div>
        </div>
    </section>
