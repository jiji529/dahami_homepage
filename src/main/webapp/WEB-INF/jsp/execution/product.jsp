...
<body>
    ...
    <section class="sublist_area">
    	<ul class="location">
			...
			<li>
				<span class="location_list">위기관리 솔루션</span>
			</li>
		</ul>
        <div class="inner">
            <h2>실행</h2>
            ...
            <div class="subtit_tit row">
                ...
                <p class="subtit_txt col7">미디어 위기관리를 위한 전용 솔루션은 <br>신문, 방송, 온라인 뉴스, SNS 등 복잡한 미디어 환경에서 최적의 제품과 서비스를 제공합니다.<br>경제적인 예산으로 업무를 효율적으로 수행하는 데 도움을 줍니다.</p>
            </div>
        </div>
    </section>
...
한국언론진흥재단 뉴스 저작권 사업단 [뉴스코리아]의 공식 유통사로서 <br>중앙부처, 지방자치단체, 공기업/공공기관, 일반기업 등 국내를 대표하는 1000여 고객사가 선택한 <br>스크랩마스터는 홍보업무 효율화를 위한 선택이 아닌 필수입니다.</div>
                ...
                <li><a href="<%=request.getContextPath()%>/execution/product_sub/clippingon.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_txt">지상파/보도전문채널/종합편성 등 국내 9개 방송사와 정식 계약을 체결해 방송뉴스 저작권 문제를 해결하였습니다.<br>예상치 못한 보도에 대한 즉각적인 대응 및 위기 관리가 가능합니다.<br>또한, 스크랩마스터와 연동을 통해 언론 스크랩 업무를 통합해 드립니다.</div>
                            <div class="more">자세히 보기</div>
                        </div>
                        <div class="prod_thumb"><span></span></div>
                    </a>
                ...
                <li><a href="<%=request.getContextPath()%>/execution/product_sub/newsplaza.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_txt">뉴스플라자는 한국언론진흥재단의 뉴스저작권 사업 중 하나로, 93개 언론사의 온라인 뉴스를 제공하고 있습니다.<br>다하미는 한국언론진흥재단 뉴스플라자 사업의 온라인 뉴스 원문 저작권 판매의 공식 대행사로<br>일평균 8천~1만 여건의 뉴스 기사를 데이터 원문 형태로 제공받아 <br>고객사가 원하는 환경에 맞게 이용이 가능하도록 서비스하고 있습니다.</div>
                            <div class="more">자세히 보기</div>
                        </div>
                        <div class="prod_thumb"><span></span></div>
                    </a>
