    ...
    <section class="sublist_area">
        ...
        <div class="inner">
            ...
            <div class="subtit_tit row">
                <h3 class="col4">Reliable tools for crisis management
</h3>
                <p class="subtit_txt col7">Dedicated solutions for media crisis management provide optimal products and services in complex media environments, including newspapers, broadcast, online news, and social media. You can do your job efficiently within a reasonable budget.</p>
            </div>
        </div>
    </section>
...
As an official distributor of [NewsKorea], the news copyright division of the Korea Press Foundation, ScrapMaster is the choice of more than 1000 customers in Korea, including central and local governments, public corporations, public institutions, and general companies.</div>
                ...
                <li><a href="<%=request.getContextPath()%>/execution/product_sub/expertEN.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_txt">Our experienced media crisis management experts will consult with you and suggest the most appropriate services.</div>
                            <div class="more">Learn More</div>
                        </div>
                        <div class="prod_thumb"><span></span></div>
                    </a>
                ...
                <li><a href="<%=request.getContextPath()%>/execution/product_sub/clippingonEN.html">
                        ...
                        <div class="prod_cont">
                            <div class="prod_tit">Clipping On</div>
...
Immediate response to unexpected coverage and crisis management.
