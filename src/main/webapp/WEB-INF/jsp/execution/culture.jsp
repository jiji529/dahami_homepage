    ...
    <section class="sublist_area">
        ...
        <div class="inner">
            ...
            <div class="subtit_tit row">
                ...
                <p class="subtit_txt col7">디지털 시대에 중요한 읽기문화의 보급, 신문활용교육 등 <br>미디어를 활용한 문화 사업을 수행하고 있습니다.<br>온라인 환경에서 뿐 만 아니라 학교, 도서관, 공공시설 등 일상 공간에서 <br>미디어를 보급하는 사업을 수행하고 있습니다.</p>
            </div>
        </div>
    </section>
