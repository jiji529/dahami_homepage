        ...
        <div class="inner">
            ...
            <div class="subtit_tit row">
                ...
                <p class="subtit_txt col7">디지털 시대에 더 중요한 읽기문화의 보급, 신문활용교육 등 미디어를 활용한 문화 사업을 수행하고 있습니다. <br>
                    온라인 환경에서 뿐 만 아니라 학교, 도서관, 공공시설 등 일상 공간에서 미디어를 보급하는 사업을 수행하고 있습니다.<br>
            ...
            <ul class="prod_li prod2">
                <li><a href="<%=request.getContextPath()%>/execution/culture_sub/tpaper.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_subtit">터치스크린과 신문의 만남 </div>
                            <div class="prod_txt">전자신문 솔루션 티페이퍼가 새로워졌습니다.<br>
                                어두웠던 디자인을 밝고 선명하게 하고 UI를 개선하여 신문 열람 시 몰입감과 사용성을 높였습니다. 새로 추가한 홈 화면에서는 오늘의 1면 주요기사, 현재 날씨, 추천 도서 등 다양한 콘텐츠를 더해 활용성을 높였습니다. 앞으로 추가될 더 다양한 기능과 콘텐츠를 기대해주세요.</div>
                ...
                <li><a href="<%=request.getContextPath()%>/execution/culture_sub/enie.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_txt">다하미는 한국언론진흥재단과 함께 사업을 운영하고 있습니다.<br>
                                신문을 통해 인지학습 능력을 키울 수 있을 뿐 아니라 가치관 및 인성까지 발달시킬 수 있습니다.</div>
                            <div class="more">자세히 보기</div>
                        </div>
                        <div class="prod_thumb"><span></span></div>
                    </a>
