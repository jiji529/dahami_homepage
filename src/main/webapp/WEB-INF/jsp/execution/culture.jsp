            ...
            <ul class="prod_li prod2">
                <li><a href="<%=request.getContextPath()%>/execution/culture_sub/tpaper.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_txt">티페이퍼가 새로워졌습니다.<br>
                                UHD와 다양한 규격의 사이즈에 대응 가능하고, 디자인과 UI를 개선하여
더욱 편한 사용감을 제공합니다. 새로 추가한 홈 화면에서는 오늘의 1면 주요기사, 현재 날씨, 추천 도서 등 다양한 콘텐츠를 더해 활용성을 높였습니다. 앞으로 추가될 더 다양한 기능과 콘텐츠를 기대해주세요.</div>
                ...
                <li><a href="<%=request.getContextPath()%>/execution/culture_sub/newsbank.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_txt">뉴스뱅크는 25개 언론사의 보도사진 650만 컷 이상을 보유하고 있는 국내 최대의 보도사진 통합 라이브러리입니다.<br>
                                신미양요, 병인양요의 19세기 사진을 비롯해 일제 강점기를 지나 6.25 전쟁을 거치고 산업화와 민주화 시대를 거쳐 오늘에 이르기까지
                                대한민국 근현대사의 중요 장면이 생생한 보도사진으로 기록되어 남아 있습니다.</div>
                            <div class="more">자세히 보기</div>
                        </div>
                        <div class="prod_thumb"><span></span></div>
                    </a>
                ...
                <li><a href="<%=request.getContextPath()%>/execution/culture_sub/enie.html">
                        ...
                        <div class="prod_cont">
                            ...
                            <div class="prod_txt">다하미는 한국언론진흥재단과 함께 사업을 운영하고 있습니다.<br>신문활용교육(e-NIE)은 한국언론진흥재단이 운영하는 포미(forme.or.kr)를 통해 제공되며, <br>당사는 각급 학교 등에 보급하는 사업을 진행하고 있습니다. <br>종이신문을 그대로 컴퓨터로 옮겨 인터넷이 접속되는 곳에서는 언제 어디서든 편리하게 신문을 스크랩하여 교육에 활용할 수 있습니다. <br>발행되는 신문이 제공되므로 학생들이 유해한 콘텐츠에 노출될 염려가 없습니다.</div>
                            <div class="more">자세히 보기</div>
                        </div>
                        <div class="prod_thumb"><span></span></div>
                    </a>
