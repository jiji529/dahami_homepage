    ...
    <div class="contents">
        ...
        <div id="job">
            <div class="job">
                ...
                <div class="job_view">
                    <div class="job_v_tit">[큐레이션] 뉴스 클리핑</div>
                    <div class="job_v_cont">
                        <dl>
                        	<dt>1. 담당 업무</dt>
                            <dd>
                            	- 뉴스 클리핑(스크랩) 업무 및 평가<br/>
								- 뉴스 및 여론동향 평가, 분석<br/>
								- 보도자료 및 보고서 작성<br/>
								- 관련 아이디어발굴 및 기획                            
                            </dd>
                            ...
                            <dd>
                            	- OA 활용 중급 이상자<br />
								- 홍보실/대변인실 대변인실 업무 경험자 <br />
								- 주도적 업무 수행 및 커뮤니케이션 가능 한 분 <br />
								- 신문과 뉴스에 대해 이해와 관심이 높으신 분 <br />
								- 기존 서비스 및 신규 서비스 기획 가능 한 분
							</dd>
