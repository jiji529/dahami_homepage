        ...
        <div class="inner">
            ...
            <div class="subtit_tit row">
                <h3 class="col4">미디어를 가장 잘 아는<br>
                    위기관리 파트너</h3>
                <p class="subtit_txt col7">다하미커뮤니케이션즈는 1998년에 창립이래 조직의 홍보, 마케팅, 전략결정 등에 필요한 뉴스 콘텐츠와 미디어 정보 솔루션을 제공하는 IT 기업입니다. <br><br>최고의 미디어 정보 전문가들이 고객 맞춤형으로 정보를 넘어 지식을 제공합니다.<br><br>
