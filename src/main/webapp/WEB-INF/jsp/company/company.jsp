        ...
        <div class="inner">
            ...
            <div class="subtit_tit row">
                <h3 class="col4">미디어를 가장 잘 아는<br>
                    위기관리 파트너</h3>
                <p class="subtit_txt col7">다하미커뮤니케이션즈는 1998년에 창립이래 조직의 홍보, 마케팅, 전략결정 등에 활용되는 수 많은 뉴스 등
                    미디어 콘텐츠와 솔루션을 공급하는 IT 기업입니다.<br><br>

                    이에 더해 수 백명의 미디어 전문가들이 적절한 정보와 최적화된 분석자료를 <br>
                    고객에게 제공하여 위기 대응에 도움을 드리고 있습니다.<br><br>

                    미디어 환경의 변화에 따라 신문, 방송, 잡지, 보도사진, 온라인 뉴스 등 <br>
