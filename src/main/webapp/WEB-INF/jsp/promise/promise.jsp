        ...
        <div class="inner">
            ...
            <div class="subtit_tit row">
                <h3 class="col5">미디어를 가장 잘 아는<br>
                    위기관리 파트너가 되겠습니다.</h3>
                <p class="subtit_txt col7">미디어 콘텐츠 허브로서 최고의 미디어 전문가 역량을 바탕으로 <br>새로운 가치를 제공하는 것은,<br>모든 고객과 비즈니스 파트너에 대한 우리의 약속입니다.</p>
            </div>
        </div>
    </section>
        ...
        <div class="inner">
            <div class="li3 reveal" id="sec1">
                ...
                <div class="li3_box">
                    ...
                    <div class="li3_cont">조직은 점점 더 복잡하고 혼란스러운 미디어 환경에 노출되고 있습니다. <br>신문, 방송, 온라인 등 미디어 콘텐츠와 서비스의 활용은 <br>조직 성장에 필수적인 요소가 되었습니다.<br>
