<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>	
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/reset.css?v=20240919">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/modal.css?v=20240919">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/style.css?v=20240919">
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/kakao.js?v=20240919"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/gnb.js?v=20240919"></script>
