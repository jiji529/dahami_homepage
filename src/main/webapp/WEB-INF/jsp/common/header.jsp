<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
            ...
            <ul class="gnb_menu">
                <li class="menu">
                    <dl class="gnb_dl">
                        <dt class="on"><a href="/company/company.html">회사소개</a></dt>
                        <dd class="">
                            <ul class="navi_sub_ul" style="display: none;">
                ...
                <li class="menu">
                    <dl class="gnb_dl">
                        <dt><a href="/service/scrapmaster.html">서비스소개</a></dt>
                        <dd class="">
                            <ul class="navi_sub_ul" style="display: none;">
                                <li><a href="/service/scrapmaster.html" target="_parent">스크랩마스터</a></li>
                                <li><a href="/service/clipping.html" target="_parent">클리핑온</a></li>
                                <li><a href="/service/tpaper.html" target="_parent">티페이퍼</a></li>
                                <li><a href="/service/newsbank.html" target="_parent">뉴스뱅크</a></li>
                                <li><a href="/service/enie.html" target="_parent">e-NIE</a></li>
                                <li><a href="/service/newsplaza.html" target="_parent">뉴스플라자</a></li>
                                <li><a href="/service/webapp.html" target="_parent">웹&amp;앱 서비스</a></li>
                            </ul>
                        </dd>
                    </dl>
                </li>
