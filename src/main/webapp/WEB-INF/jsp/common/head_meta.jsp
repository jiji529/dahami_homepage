...
<c:set var="URL" value="${requestScope['javax.servlet.forward.servlet_path']}" />
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <title>다하미커뮤니케이션즈</title>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/reset.css?v=20231227-4">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/modal.css?v=20231227-4">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/style.css?v=20231227-4">
    <script type="text/javascript" src="<%=request.getContextPath()%>/js/gnb.js?v=20231227-4"></script>
