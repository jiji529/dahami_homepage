...
<body>
    ...
    <section class="sublist_area">
		<ul class="location">
			...
			<li>
				<span class="location_list">Company News</span>
			</li>
		</ul>
        <div class="inner">
            <h2>News</h2>
            <div class="tab">
                <div class="tab_menu on"><a href="<%=request.getContextPath()%>/news/newsEN.html">Company News</a></div>
                <div class="tab_menu"><a href="<%=request.getContextPath()%>/news/instaEN.html">Whatssupnews</a></div>
            </div>
        </div>
    </section>
    ...
    <section class="sub_news">
        <div class="inner">
            ...
            <div class="m_news">
                ...
                <div class="btn_area"><button class="btn btn_bk" onclick="loadMoreNews('1')">View More</button></div>
            </div>
        </div>
    </section>
