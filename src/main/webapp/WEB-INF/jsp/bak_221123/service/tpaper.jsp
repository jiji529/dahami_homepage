    ...
    <div class="contents">
        ...
        <div id="sub_cont">
            <div class="tp_title">
                ...
                <div class="serv_txt">
                    <p>디지털도서관 및 로비 디스플레이를 위한<br>최고의 전자신문 솔루션 <b>티페이퍼</b><br><br>전자신문 솔루션 티페이퍼가 새로워졌습니다.<br><br>어두웠던 디자인을 밝고 선명하게 하고 UI를 개선하여 신문 열람 시 몰입감과 사용성을 높였습니다.<br>새로 추가한 홈 화면에서는 오늘의 1면 주요기사, 현재 날씨, 추천 도서 등 다양한 콘텐츠를 더해 활용성을 높였습니다.<br><br>앞으로 추가될 더 다양한 기능과 콘텐츠를 기대해주세요.</p>
            ...
            <div class="sub_box tp1">
                <div class="text_box tbr">
                    <h3>신문보기</h3>
                    <p>매일 아침 자동으로 당일자 신문을 준비합니다.<br><br>구독 중인 모든 신문 목록을 한 번에 확인할 수 있습니다.<br>최대 1년 이내 발행된 신문을 자유롭게 선택해 보세요.<br><br>또, 선택한 신문의 전체 기사 목록을 보면서<br>면 단위나 기사 단위로 편하게 이동할 수 있습니다.</p>
                </div>
            </div>
            <div class="sub_box tp2">
                <div class="text_box tbl">
                    <h3>검색하기</h3>
                    <p>많은 양의 기사를 검색해도 빠르게<br>검색결과를 출력합니다.<br>새로 추가한 검색결과 정렬 기능을 이용해<br>원하는 기사를 더 빠르게 찾아보세요.<br><br>추후 검색 기간을 지정하는 기능도 추가할 예정입니다.</p>
                </div>
            ...
            <div class="sub_box tp3">
                <div class="text_box tbr">
                    <h3>다양한 부가 기능</h3>
                    <p>고화질 홍보 영상과 티커가 홈 화면에서 항시<br>노출되도록 해 홍보 효과를 높였습니다.<br><br>미사용 시 뜨는 화면보호 기능인 대기화면의<br>다양한 옵션을 통해 동영상이나 이미지, 지면 등을<br>보여줄 수 있습니다.</p>
                </div>
            </div>
            <div class="sub_box tp4">
                <div class="text_box tbl">
                    <h3>효율적인 관리 시스템</h3>
                    <p>종이신문을 비치하고 보관하는 데 드는<br>노력과 공간을 절감할 뿐만 아니라<br>키오스크 자동 실행, 신문 자동 업데이트, 이용 통계 등<br>기기를 관리하는 데 도움이 되는<br>다양한 관리자 기능을 제공합니다.</p>
                </div>
            </div>
        </div>
    </div>
