    ...
    <div class="contents">
        ...
        <div id="sub_cont">
            <div class="clipp_title">
                ...
                <div class="serv_txt">
                    <p>지상파/보도전문채널/종합편성 등 국내 9개 방송사와 정식 계약을 체결해 <br>방송뉴스 저작권 문제를 해결하였습니다.<br><br>예상치 못한 보도에 대한 즉각적인 대응 및 위기 관리가 가능합니다.<br>또한, 스크랩마스터와 연동을 통해 언론 스크랩 업무를 통합해 드립니다.</p>
            ...
            <div class="sub_box cp1">
                <div class="text_box tbr">
                    ...
                    <p>원 스탑으로 모든 방송사의 뉴스 검색이 가능합니다.<br>번거롭게 여러 사이트에서 검색하실 필요가 없습니다.<br>오직 클리핑온 하나면 충분합니다.</p>
                </div>
            </div>
            <div class="sub_box cp2">
                <div class="text_box tbl">
                    <h3>자동검색/필터링</h3>
                    <p>사용자가 지정한 검색 키워드로<br>방송뉴스를 자동 검색 및 필터링 하여 제공합니다.<br>수 많은 키워드를 일일히 검색하실 필요도 없습니다.<br>키워드별로 날짜/방송사/프로그램을 저장해 놓으면<br>자동으로 검색해 드립니다.</p>
                </div>
            </div>
            <div class="sub_box cp3">
                <div class="text_box tbr">
                    <h3>모바일 알리미 서비스</h3>
                    <p>설정해 놓은 키워드로 뉴스를<br>원하는 시간에 알려드립니다.<br>모니터링 즉시 알려주는 실시간 알림 기능으로<br>예상치 못한 보도에 대한<br>즉각적인 대응 및 위기 관리가 가능합니다.</p>
                </div>
            </div>
        </div>
    </div>
