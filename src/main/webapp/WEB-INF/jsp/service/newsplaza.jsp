    ...
    <div class="contents">
        ...
        <div id="sub_cont">
            <div class="np_title">
                ...
                <div class="serv_txt">
                    <p>뉴스플라자는 한국언론진흥재단의 뉴스저작권 사업 중 하나로, 69개 언론사의 온라인 뉴스를 제공하고 있습니다.<br><br>다하미커뮤니케이션즈는 한국언론진흥재단 뉴스플라자 사업의 온라인 뉴스 원문 저작권 판매의 공식 대행사로<br>일평균 8천~1만 여건의 뉴스 기사를 데이터 원문 형태로 제공받아<br>고객사가 원하는 환경에  맞게 이용이 가능하도록 서비스하고 있습니다.</p>
                    <a href="http://news-plaza.com/newsml/" target="_blank">뉴스플라자 바로가기</a>
                </div>
            </div>
            <div class="sub_box np1">
                <div class="text_box tbr">
                    <h3>다양한 용도로 활용</h3>
                    <p>홈페이지 게시, 스크랩, 인트라넷 활용 등<br>온라인 뉴스를 다양한 목적에 맞게<br>간편하게 이용할 수 있습니다.</p>
                </div>
            </div>
            ...
            <div class="sub_box np3">
                <div class="text_box tbr">
                    <h3>통합 서비스</h3>
                    <p>고객사 내부망에서 활용할 수 있도록<br>카테고리별로 분류된 뉴스의<br>원문 데이터를 통합하여 제공합니다.</p>
                </div>
            </div>
        </div>
    </div>
