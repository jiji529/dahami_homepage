    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function addVerticalNavigation(){
            $("#wrap").append('<div id="' + SECTION_NAV + '"><ul></ul></div>');
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            if(typeof element === 'undefined'){ return; } //there's no element to scroll, leaving the function
                if(element.closest('div').attr('id') == "section0"){
                	//alert("page animationCss1");
                	animationCss1();
                    clearInterval(2);
                }else if(element.closest('div').attr('id') == "section1"){
                	//alert("page animationCss2");
                    animationCss2();
                    //clearInterval(2);
                }else if(element.closest('div').attr('id') == "section2"){
                    animationCss3();
                    clearInterval(2);
                }else{
                    animationCss1();
